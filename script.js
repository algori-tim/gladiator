...
function draw() {
  ...
  if(enemyObject.attackInRange && enemyObject.isAttacking == false && enemyAttackPointCounter > enemyAttackPointSetter){
  ...
  if(playerObject.health < 1){
    ...
    alert("You seem to have died... You have slain " + dummiesKilled + " warriors!");
    document.location.href = "index.html";
  }

  document.getElementById("dummyHealth").innerHTML = "Dummy Health: " + enemyObject.health;
  document.getElementById("playerHealth").innerHTML = "Player Health: " + playerObject.health;
  document.getElementById("dummiesKilled").innerHTML = "Dummies Killed " + dummiesKilled;
  ...
  document.getElementById("enemyX").innerHTML = "Enemy X: " + Math.floor(enemyCenterX);
  document.getElementById("enemyY").innerHTML = "Enemy Y: " + Math.floor(enemyCenterY);
  document.getElementById("playerX").innerHTML = "Player X: " + Math.floor(playerObject.centerX);
  document.getElementById("playerY").innerHTML = "Player Y: " + Math.floor(playerObject.centerY);
  document.getElementById("attackSetter").innerHTML = "AttackSetter: " + enemyAttackPointSetter;
...
function drawStats() {
  ...
  canvasContext.fillRect(enemyObject.healthBarX + 13, enemyObject.healthBarY, enemyObject.health, 6);
  canvasContext.stroke();
}
